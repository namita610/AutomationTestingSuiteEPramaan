...
public class ForgotPasswordDL{
    ...
    @Test
    public void ForgotPasswordDLTest() {
        ...
        try {
            ...
            idField.sendKeys(AppConstant.DLNo);
          ...
          dobSpan.click();
            ...
            passwordField.sendKeys(AppConstant.Password);  // Replace with your password

            // Fill in Confirm Password
            WebElement confirmPasswordField = driver.findElement(By.id("confirmPassword"));
            confirmPasswordField.sendKeys(AppConstant.ConfirmPassword);  // Must match password
