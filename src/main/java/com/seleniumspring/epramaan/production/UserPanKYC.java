...
public class UserPanKYC {
    ...
    public void UserPanKYCTest() {
        ...
        try {
            ...
            // Click PAN button using JS (if needed)
            ...
            panNumberField.sendKeys(AppConstant.PanNo);

            Thread.sleep(1000);
            
            WebElement nameField = wait.until(ExpectedConditions.elementToBeClickable(By.id("name_as_in_pan")));
            nameField.clear(); // Add this line
            nameField.sendKeys(AppConstant.Name_as_in_Pan);
