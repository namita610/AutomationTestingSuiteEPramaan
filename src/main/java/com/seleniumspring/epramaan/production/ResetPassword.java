    ...
    public void UserResetPassword() {
       ...
       // System.setProperty("webdriver.chrome.driver", AppConstants.URL);
        ...
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("oldPassword"))).sendKeys(AppConstant.Password);
            driver.findElement(By.id("newPassword")).sendKeys(AppConstant.NewPasswordForReset);
            driver.findElement(By.id("confirmPassword")).sendKeys(AppConstant.ConfirmPasswordForReset);
