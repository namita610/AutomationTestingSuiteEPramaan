    ...
    public void ForgotPasswordAadharNumberTest() {
       ...
       // WebDriverWait wait = new WebDriverWait(driver, 10); // For Selenium 3
        ...
        try {
            ...
            idField.sendKeys(AppConstant.AadharNo_staging);
            ...
            passwordField.sendKeys(AppConstant.NewPasswordForForgot_staging);  // Replace with your password

            // Fill in Confirm Password
            WebElement confirmPasswordField = driver.findElement(By.id("confirmPassword"));
            confirmPasswordField.sendKeys(AppConstant.ConfirmPasswordForForgot_staging);  // Must match password
