...
public class ForgotPasswordUserName {
    ...
    public void ForgotPasswordUserNameTest() {
        ...
        //WebDriverWait wait = new WebDriverWait(driver, 10); // For Selenium 
        ...
        try {
            ...
            new Select(selectTypeDropdown).selectByValue(AppConstant.Username_staging);

      
            WebElement idField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user.otherTypeNumber")));
            idField.sendKeys(AppConstant.Username_staging);
