...
public class UnlockAccountByMobile {

    @Test
    public void UnlockAccountByMobileTest() {
        ...
        try {
            ...
            // STEP 2: Click "Using Mobile"
            WebElement usingMobileLink = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//a[@href='/auth/loadUnlockAccount.do?activationMedium=mobileNumber']")));
