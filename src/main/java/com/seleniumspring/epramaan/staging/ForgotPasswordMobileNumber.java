...
public class ForgotPasswordMobileNumber{
    ...
    public void ForgotPasswordMobileNumberTest() {
        ...
        try {
         ...
         dobSpan.click();
            ...
            wait.until(ExpectedConditions.textToBePresentInElementLocated(By.id("selectUser"), "namita_pan_dl_staging"));
            new Select(selectUserDropdown).selectByValue("namita_pan_dl_staging");
